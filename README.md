...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/ancient-hill-860e
```

A live public deployment of this template is available at [https://ancient-hill-860e.templates.workers.dev](https://ancient-hill-860e.templates.workers.dev)
